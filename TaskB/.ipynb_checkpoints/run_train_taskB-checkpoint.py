...
def main():
    ...
    parser.add_argument('--output_dir', type=str, default='setu4993/LaBSE-multilingual', help='path to save model')      
    ...
    train = pd.read_csv(data_dir+'train_dev.tsv', delimiter="\t")
    ...
    for i in range (1):
        ...
        #warmup_steps=50,)#lr_scheduler_type="cosine")# directory where the trained model willbe saved #or we can use (push_to_hub=True) in the TrainingArguments if we want to automatically upload your model to the Hub
