...
def main():
    ...
    file_name = '/home/sanala/Juputer try/afrisenti/TaskB/'+'multilingual_test_participants.tsv'#tg_dev
    ...
    df.to_csv(os.path.join(SUBMISSION_PATH, 'pred_multilingual.tsv'), sep='\t', index=False) ##pred_tg.tsv
