...
test = pd.read_csv('test_gold/'+args.task+'_test_gold_label.tsv', delimiter="\t")
...
f = open("/home/sanala/Juputer try/afrisenti/TaskA/results-taskA/"+args.task+'-'+args.submission, 'a')
